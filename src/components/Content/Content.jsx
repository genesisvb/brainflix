...
function Content({ selectedVideo }) {
  const time = dayjs(selectedVideo.timestamp).fromNow();
      ...
      <div className="content__info-container">
        ...
        <div className="content__counts">
          <p className="content__count">
            <img className="content__icon" src={viewsIcon} alt="views icon" />{" "}
            {selectedVideo.views}
          </p>
          <p className="content__count">
            <img className="content__icon" src={likesIcon} alt="likes icon" />{" "}
            {selectedVideo.likes}
          </p>
        </div>
      </div>
